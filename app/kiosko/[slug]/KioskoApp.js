...
function LeadCapture({ slug, source, preferencias, vinosRecomendados, gourmet = [], itemsCesta, lang = 'es' }) {
  ...
  const T = {
    es: {
      ...
      consent:   'Acepto recibir mi selección y comunicaciones comerciales con novedades y ofertas de vino. Puedo cancelar en cualquier momento.',
    ...
    en: {
      ...
      consent:   'I agree to receive my selection and commercial communications about wine news and offers. I can unsubscribe anytime.',
    ...
    fr: {
      ...
      consent:   "J'accepte de recevoir ma sélection et des communications commerciales sur les nouveautés et offres de vin. Je peux me désinscrire à tout moment.",
    ...
    de: {
      ...
      consent:   'Ich stimme zu, meine Auswahl und kommerzielle Mitteilungen über Weinneuheiten und Angebote zu erhalten. Ich kann jederzeit abbestellen.',
  ...
  return (
    <div className={styles.pairingView}>
      ...
      <div className={styles.pairingInputArea}>
        <p className={styles.sugerenciasLabel}>{T[lang].pairingOEscribe}</p>
