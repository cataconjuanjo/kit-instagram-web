...
const recorridos = [
  {
    ...
    text: 'La grafica clave del sumiller: que referencias son estrella, joya oculta, caballo de batalla o candidato a revisar.',
  ...
  },
  {
    ...
    text: 'Pedido sugerido por proveedor, bajo minimo, margen bajo, rotacion y propuestas listas para decidir.',
  ...
  },
  {
    ...
    text: 'Conteo por prioridad: premium, copa, bajo minimo, inmovilizado y referencias criticas.',
    href: '/dashboard/inventario?demo_sumiller=1',
    cta: 'Ver inventario',
    metrics: ['Conteo rapido', 'Ajustes', 'Impacto'],
  },
  {
    id: 'simulador',
    eyebrow: '6 - Direccion',
    title: 'Simulador de margen',
    text: 'Escenarios para defender PVP, copa, margen, stock parado y coste de oportunidad ante direccion.',
...
const guion = [
  'Abrir el mapa estrella/joya y explicar que Carta Viva Bodega no sustituye criterio: ordena senales para decidir.',
  ...
  'Entrar en Stock y pedido: copiar pedido por proveedor y revisar bajo minimo, cobertura y rotacion.',
  'Abrir Catalogo distribuidores: buscar una referencia, comparar coste/PVP y explicar alta de ficha.',
  'Pasar al Constructor de carta: ordenar secciones y exportar una version limpia para maquetar.',
  'Abrir Inventario: contar referencias criticas, no toda la bodega en orden alfabetico.',
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        <div>
          ...
          <p>
            Una membresia centrada en gestion profesional: mapa de vinos estrella y joyas, stock,
            compras, catalogo de distribuidores, margen, inventario y argumentos para direccion.
          </p>
          <div className={styles.actions}>
        ...
        <aside className={styles.snapshot}>
          ...
          <span>5 proveedores - 90 dias de ventas - catalogo profesional - estrellas, joyas, pedidos y movimientos</span>
        </aside>
      </section>
      ...
      <section className={`${styles.section} ${styles.spotlight}`}>
        <div>
          ...
          <p>
            La demo empieza por el mapa que un sumiller puede ensenar a direccion:
            margen, salida real, retorno de inventario y accion sugerida por referencia.
          </p>
        </div>
