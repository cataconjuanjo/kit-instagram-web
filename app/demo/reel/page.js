const slides = [
  ...
  },
  {
    ...
    title: 'Codillo al Pedro Ximénez',
    ...
    tags: ['Textura', 'Salsa', 'Método'],
  },
  {
    eyebrow: 'Ficha de venta',
    title: 'Qué buscar y qué evitar',
    text: 'Buscar estructura, fruta madura y acidez. Evitar vinos ligeros, secantes o sin frescura.',
    detail: 'El camarero sabe qué decir antes de recomendar.',
    tags: ['Buscar', 'Evitar', 'Frase'],
  },
  {
    eyebrow: 'Vinos compatibles',
    title: 'Tres opciones de la carta',
    text: 'Fácil de vender, recomendado y premium. Siempre con vinos reales del restaurante.',
    detail: 'La recomendación se apoya en la carta existente, no inventa botellas.',
    tags: ['Fácil', 'Top', 'Premium'],
  },
  {
    eyebrow: 'Rotación inteligente',
    title: 'Otras opciones compatibles',
    text: 'Si el restaurante quiere rotar stock, la app abre alternativas válidas sin romper el criterio.',
    detail: 'No siempre empuja el mismo vino.',
    tags: ['Stock', 'Margen', 'Rotación'],
  },
  {
