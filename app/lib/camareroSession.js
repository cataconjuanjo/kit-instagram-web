...
function secreto() {
  return process.env.SALA_SESSION_SECRET || process.env.SUPABASE_SERVICE_ROLE_KEY || ''
}
...
export function crearSesionCamarero(restauranteId) {
...
export function validarSesionCamarero(token, restauranteId) {
  try {
