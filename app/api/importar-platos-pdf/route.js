...
export async function POST(req) {
  try {
    ...
    const message = await anthropic.messages.create({
      ...
      max_tokens: 4000,
      system: 'Eres un extractor de cartas de restaurante. Tu trabajo es leer PDFs e imágenes de cartas de comida y devolver platos limpios para importar en una aplicación. No inventes platos. No incluyas vinos, bebidas, menús legales, alérgenos sueltos, horarios ni texto promocional. Responde solo en texto plano.',
      messages: [{
        role: 'user',
        content: [
          entrada,
