...
const TEMPORARILY_PAUSED_SQUARE_SYNC_SLUGS = parseEnvList(process.env.SQUARE_SYNC_PAUSED_SLUGS_EXTRA || '')
...
function decideSquareCatalogImport(tiendaSlug, squareCategories = [], rawNombre = '') {
  ...
  // Allowlist de vinos por categoría Square. expandCategoryIds() sube hasta el padre,
  // así que "Rioja" resuelve a "Vinos peninsulares" y isVino es fiable.
  // Lo que no sea vino va a 'otro' — sin heurísticas de nombre.
