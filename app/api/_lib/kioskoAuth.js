...
export const ADMIN_VINO_SELECT =
  'id, nombre, bodega, tipo, uva, region, pais, anada, precio_pvp, precio_coste, precio_oferta, stock, stock_minimo, ubicacion_estanteria, foto_url, notas_cata, descripcion, puntuacion, destacado, activo, ficha_ia, square_catalog_id, categoria, apto_cesta, es_vegano, con_alcohol, cat_gourmet'
...
const WRITABLE_VINO_FIELDS = new Set([
  ...
  'apto_cesta', 'es_vegano', 'con_alcohol', 'cat_gourmet',
])
