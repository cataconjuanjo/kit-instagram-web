...
const styles = {
  page: { minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#F8F7F4', padding: 20, fontFamily: 'system-ui, sans-serif' },
  card: { width: 'min(520px, 100%)', border: '1px solid #ddd6cb', borderRadius: 12, background: '#fffdf8', padding: 28 },
  eyebrow: { margin: '0 0 10px', color: '#8B3F5C', fontSize: 11, fontWeight: 900, letterSpacing: '0.14em', textTransform: 'uppercase' },
  ...
  primary: { minHeight: 42, border: 0, borderRadius: 8, background: '#531827', color: '#fff', padding: '0 16px', cursor: 'pointer', fontWeight: 850 },
