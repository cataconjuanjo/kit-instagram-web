...
import {
  ...
  calcularRangoBotellaParaTicket,
  calcularTicketMesaVenta,
  calcularTicketReferenciaVenta,
  formatoVentaParaVino as calcularFormatoVentaParaVino,
  numeroContexto,
  precioBotellaVenta as precioBotella,
  precioUnidadVenta,
} from '../../lib/camareroPricingUtils'
...
export default function Camarero() {
  ...
  function formatoVentaParaVino(vino) {
    return calcularFormatoVentaParaVino(vino, contextoServicio.formato)
  }
  ...
  function ticketMesaVenta() {
    return calcularTicketMesaVenta({ platosMesaVenta, consultaVenta })
  }

  function rangoBotellaParaTicket(ticketComida, precioMedio) {
    return calcularRangoBotellaParaTicket(ticketComida, precioMedio)
  }

  function ticketReferenciaVenta() {
    return calcularTicketReferenciaVenta({
      restaurante,
      ticketMesa: ticketMesaVenta(),
      platosVenta,
      vinos,
    })
  }
  ...
  function gamasVenta() {
    return calcularGamasVenta(ticketReferenciaVenta().valor)
  }

  function gamaActivaVenta() {
    return calcularGamaActivaVenta(gamasVenta(), perfilClienteVenta.gama)
  }

  function precioMedioVinosVenta() {
    return calcularPrecioMedioVinosVenta(
      vinos,
      vino => esVinoElegibleParaObjetivo(vino, { ignorarGama: true })
    )
  }
