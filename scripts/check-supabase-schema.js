...
const requiredChecks = [
  ...
  {
    label: 'restaurantes dashboard client',
    table: 'restaurantes',
  ...
  {
    label: 'vinos dashboard client',
    table: 'vinos',
    select: 'id, restaurante_id, nombre, bodega, tipo, region, uva, anada, precio_botella, precio_copa, coste_compra, stock, stock_minimo, proveedor, referencia_proveedor, formato_compra, notas_cata, activo, internacional',
  },
  {
    label: 'platos core',
    table: 'platos',
  ...
  {
    label: 'movimientos stock dashboard client',
    table: 'movimientos_stock',
    select: 'id, restaurante_id, vino_id, tipo, cantidad, stock_anterior, stock_nuevo, motivo, created_at, vinos(nombre, bodega)',
  },
  {
